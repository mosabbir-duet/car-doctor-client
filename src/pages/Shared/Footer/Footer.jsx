    ...
    <>
      <footer className="footer p-32 bg-[#151515]  text-white">
        <div>
          <img src={logo} alt="" />
          <p className="text-lg">
            Car Doctor is <br />a one-stop platform that provides solutions
            <br /> for all your automobile needs, no <br /> matter which car you
            own nor what issue <br /> your car may have.
          </p>
        ...
        <div>
          ...
          <a className="link link-hover text-lg">Accessibility</a>
        </div>
      </footer>
    </>
  );
